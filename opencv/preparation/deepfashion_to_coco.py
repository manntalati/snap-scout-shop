...
for num in range(1,num_images+1):
    json_name = 'data/deepfashion2/images/val/validation/annos/' + str(num).zfill(6)+'.json'
    image_name = 'data/deepfashion2/images/val/validation/image/' + str(num).zfill(6)+'.jpg'
...
json_name = 'val_deepfashion2.json'
